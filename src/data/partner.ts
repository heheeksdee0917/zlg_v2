...
export const journeyPartners: JourneyPartner[] = [
  ...
  { name: 'nike baetzner', title: 'researcher, historian',image:'/general/partners/nike_solo.avif' },
  { name: 'suburbia books', title: 'publisher', image:'/general/partners/surburia_duo.avif' },
