...
export const journeyPartners: JourneyPartner[] = [
  ...
  { name: 'professor dr. zora gabrovsek', title: 'gallerist, film producer', image:'/general/partners/zora_solo.avif' },
  { name: 'nike baetzner', title: 'researcher, art historian',image:'/general/partners/nike_solo.avif' },
  { name: 'naadiya hani and ashran bahari', title: 'suburbia projects, publisher ', image:'/general/partners/surburia_duo.avif' },
  { name: 'Suzanne Lee', title: 'co-founder and creative media lead at AltStudio', image:'/general/partners/suzannelee_solo.avif' },
  { name: 'Sanjit Das', title: 'Photographer, artistic lead at AltStudio', image:'/general/partners/sanjit_solo.avif' },
